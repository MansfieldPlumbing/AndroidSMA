...
namespace Subsystem.Capabilities.Terminal;
...
internal sealed class ConsoleTerminal : PSHost
{
    private readonly ConsoleTerminalUserInterface _ui = new();
...
internal sealed class ConsoleTerminalUserInterface : PSHostUserInterface
{
    private readonly ConsoleTerminalRawUserInterface _raw = new();
...
internal sealed class ConsoleTerminalRawUserInterface : PSHostRawUserInterface
{
    private readonly int _w;
    public ConsoleTerminalRawUserInterface()
    {
        int w = 120;
